...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA1     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(GPIOA, X_encoderA_Pin|X_encoderB_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PC7     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(Y_encoderA_GPIO_Port, Y_encoderA_Pin);

    HAL_GPIO_DeInit(Y_encoderB_GPIO_Port, Y_encoderB_Pin);
