...
//		  S_M[i].S_status = 1;
//		  debug_send_state(S_M[i].S_status, i);
//		  HAL_Delay(100); //ÑÓÊ±500ºÁÃë
//		  debug_send_speed(S_M[i].S_speed, i);
//		  HAL_Delay(100); //ÑÓÊ±500ºÁÃë
//		  debug_send_pos(S_M[i].S_position, i);
//		  HAL_Delay(200); //ÑÓÊ±500ºÁÃë
	  }
		  HAL_Delay(1000); //ÑÓÊ±500ºÁÃë
  }
  /* USER CODE END 3 */
}
